...
class Naitonotabi1 {
    public static void main(String args[]){
        ...
        System.out.println("通ったマスが口から国に変わります。");
        System.out.println("一度通ったマスは通れません。");
        System.out.println("すべてのマスを国に変えましょう。");
        ...
        System.out.println("開始地点を入れてください");
        Scanner startPoint = new Scanner(System.in);

        int plased1 = startPoint.nextInt() - 1;  //初期値
        int plased2 = startPoint.nextInt() - 1;  //初期値
